...
import './PhamacyLogin.css';
import images from './Photos/logb.jpg';

export default function PhamacyLogin() {
    ...
    const handleSubmit = async (e) => {
     ...
     const data = await response.json();
      ...
      if (response.ok) {
        ...
        window.location.href='http://localhost:3000/phamacyLog';
      } else {
 ...
 return (
   ...
   <div>
      <h1 className='phar-h1-log'>Pharmacy Management System</h1>
