...
/*DATA IN DRUG Prescription*/
const DrugPrescription = (props) => {
    ...
    const deleteHandler =async () =>{
      await axios
      .delete(`http://localhost:5000/prescriptions/deletePrescription/${_id}`)
      .then(res=>res.data)
      .then(alert("Deleted Successfully!"))
      .then(()=>history(`/viewPatientProfileForDoc/${patientRegNo}`))
      .then(()=>history(`/viewPrescriptions/${patientRegNo}`));
    }
            ...
            <div className='Dform-f'>
              ...
              <label className='Dform-h3' >Recommended Drugs:</label>
                ...
                <table className='Dform-b'>
                  <tr>
                    <th><Link to={`/viewPatientProfileForDoc/${patientRegNo}`}class="form-button-4">Back</Link></th>
                    <th className='w'></th>
