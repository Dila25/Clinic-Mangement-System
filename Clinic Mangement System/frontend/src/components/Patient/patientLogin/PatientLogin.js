...
import plog from './Photos/plog.png';
...
export default function PatientLogin() {
    ...
    const handleSubmit = async (e) => {
     ...
     const data = await response.json();
      ...
      if (response.ok) {
        ...
        window.location.href='http://localhost:3000/patientHome1';
      } else {
 ...
 return (
   ...
   <div>
       <h1 className='phar-h1-log'>Patient Management System</h1>
   <div className='login-Main'>
       ...
       <div class="login-row">
           ...
           <img src={plog} className="login-signin" alt="signin logo"  width={"700%"}/> 
           </div>
