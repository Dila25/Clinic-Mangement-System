...
import '../LabLogin/LaborataryLogin.css';
import lblog from './Photos/lblog.jpg';
...
export default function LaboratoryLogin() {
    ...
    const handleSubmit = async (e) => {
     ...
     const data = await response.json();
      ...
      if (response.ok) {
        ...
        window.location.href='http://localhost:3000/labMainHome';
      } 
 ...
 return (
   ...
   <div>
       <h1 className='phar-h1-log'>Laboratory Management System</h1>
        <div className='login-Main'>
            ...
            <div class="login-row">
                ...
                <img src={lblog} className="login-signin" alt="signin logo"  width={"700%"}/> 
                </div>
